...
vim.keymap.set("n", "<leader>ga", "<cmd>DiffviewOpen<cr>", { desc = "Git: Open Diffview" })
vim.keymap.set("n", "<leader>gO", "<cmd>DiffviewOpen<cr>", { desc = "Git: Open Diffview" })
vim.keymap.set("n", "<leader>gA", "<cmd>DiffviewClose<cr>", { desc = "Git: Close Diffview" })
...
vim.keymap.set("n", "<leader>gL", "<cmd>DiffviewFileHistory %<cr>", { desc = "Git: Current File History" })
